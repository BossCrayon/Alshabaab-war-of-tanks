...
while load:
    ...
    if game_state == MENU:
        ...
        draw_text_with_shadow("GAME CONTROLS", title_font, GOLD, BLACK, scrn_width // 2, 100, center=True)

        pygame.draw.rect(scrn, (50, 0, 0), (100, 200, 500, 500))
        pygame.draw.rect(scrn, RED, (100, 200, 500, 500), 4)
        draw_text("PLAYER 1", subtitle_font, RED, 350, 250, center=True)
        draw_text("MOVE: W A S D", button_font, WHITE, 350, 350, center=True)
        draw_text("SHOOT: L-CTRL", button_font, WHITE, 350, 450, center=True)

        pygame.draw.rect(scrn, (0, 0, 50), (680, 200, 500, 500))
        pygame.draw.rect(scrn, BLUE, (680, 200, 500, 500), 4)
        draw_text("PLAYER 2", subtitle_font, BLUE, 930, 250, center=True)
        draw_text("MOVE: ARROW KEYS", button_font, WHITE, 930, 350, center=True)
        draw_text("SHOOT: R-SHIFT", button_font, WHITE, 930, 450, center=True)
        ...
        lines = [
            ...
            "   (Scout, Heavy, Assault, or Sniper)",
            "2. Each tank has different Speed and Health.",
            "3. Dodge bullets and shoot the enemy.",
            "4. After every win both players can choose Tanks again.",
        ...
        for i in range(4):
            ...
            draw_text(f"BulletSpeed: {stats['b_speed']}", smallfont, WHITE, x_base + 10, 410)
